...
class UserModel extends CI_Model
{
  ...
  function edituser($uid, $username, $email, $password,$occupation,$birth )
  {
    $sql = "UPDATE `Users` SET `username`='$username',`password`='$password',`email`='$email' ,`birth`='$birth',`occupation`='$occupation' WHERE uid=$uid";
    $query = $this->db->query($sql);
  }
  function getqu()
  {
